...
<nav class="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 py-4 bg-white shadow h-16">
  ...
  <div class="flex items-center gap-4">
    ...
    <div class="rounded-full bg-pink-500 text-white font-bold w-8 h-8 flex items-center justify-center">
      <?php echo e(strtoupper(Auth::guard('admin')->user()->name[0])); ?>
...
<div class="flex pt-16 h-full">
  ...
  <aside class="fixed top-16 left-0 w-64 h-[calc(100%-4rem)] bg-white shadow overflow-y-auto hover:overflow-y-scroll p-4 flex flex-col justify-between" id="sidebar">
    <div class="space-y-2">
      <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-2 p-2 rounded <?php echo e(request()->is('admin/dashboard') ? 'text-blue-600 font-bold bg-blue-50' : 'hover:bg-gray-100'); ?>">
        <i class="bi bi-house"></i><span>Dashboard</span>
      </a>
      <a href="<?php echo e(route('admin.leads.index')); ?>" class="flex items-center gap-2 p-2 rounded <?php echo e(request()->is('admin/leads*') ? 'text-blue-600 font-bold bg-blue-50' : 'hover:bg-gray-100'); ?>">
        <i class="bi bi-person-lines-fill"></i><span>Leads</span>
      </a>
      <a href="<?php echo e(url('setting')); ?>" class="flex items-center gap-2 p-2 rounded <?php echo e(request()->is('setting') ? 'text-blue-600 font-bold bg-blue-50' : 'hover:bg-gray-100'); ?>">
        <i class="bi bi-gear"></i><span>Settings</span>
      </a>
    </div>

    <div>
      <a href="<?php echo e(route('admin.logout')); ?>" class="flex items-center gap-2 p-2 rounded hover:bg-red-100 text-red-600">
...
<?php /**PATH C:\xampp\htdocs\LoopLynks2\resources\views/layouts/admin.blade.php ENDPATH**/ ?>