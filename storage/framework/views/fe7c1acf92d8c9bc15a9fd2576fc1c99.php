...
<div class="bg-white p-6 rounded-[10px] shadow">
    ...
    <div class="flex justify-between items-center mb-4">
        <div class="text-sm text-gray-500">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-blue-600 hover:underline">Dashboard</a> /
            <a href="<?php echo e(route('admin.leads.index')); ?>" class="text-blue-600 hover:underline">Leads</a> /
            <span class="text-gray-700 font-semibold">Create Lead</span>
        </div>
        <a href="<?php echo e(route('admin.leads.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-[10px] shadow">
            Save
        </a>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\LoopLynks2\resources\views/admin/leads/create.blade.php ENDPATH**/ ?>